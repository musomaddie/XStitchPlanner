...
class LimiterSelectorStack(QStackedWidget):
    ...
    def __init__(
        ...
        no_selector_layout_widget.setLayout(LimiterValueSelector(
        ...
        between_layout_widget.setLayout(LimiterValueSelector(
